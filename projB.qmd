...
Unlike 432 Project A, NHANES data are a completely acceptable choice for Project B, although we do require you to use the demographics file and at least two other NHANES files in developing your data set. See the [Fall 2022 431 Project B instructions on Using NHANES data](https://thomaselove.github.io/431-projectB-2022/data2.html) for more information on NHANES. If you use NHANES data or other large (weighted) survey data, you are welcome to do any or all of Project B without incorporating sampling weights.
...
You will specify at least seven one-hour time slots within these windows (using at least two different days) as times when you (and your partner, if any) are available to give your project.
...
In Project B, for outcome transformations, follow our advice [from Project A](projectA.qmd#transformations).
