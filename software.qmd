...
pkgs <- c(  "afex", "aplpack", "aplore3", "arm", "babynames", "bestglm", 
            "boot", "broom", "car", "caret", "cowplot", "DataExplorer", 
            "DescTools", "devtools", "distributions3", "Epi", "exact2x2", 
            "ez", "faraway", "fivethirtyeight", "foreign", "gapminder", 
            "gee", "geepack", "GGally", "ggdist", "ggforce", "ggrepel", 
            "ggridges", "ggstance", "ggthemes", "glue", "gmodels", 
            "gridExtra", "gt", "gtExtras", "gtsummary", "here", "Hmisc", 
            "HSAUR", "infer", "janitor", "kableExtra", "knitr", "lars", 
            "lattice", "leaps", "lmboot", "lme4", "lmerTest", "lmtest", 
            "lvplot", "magrittr", "markdown", "MASS", "mice", "mitml", 
            "MKinfer", "modelsummary", "moderndive", "mosaic", "multcomp", 
            "naniar", "NHANES", "nhanesA", "nnet", "palmerpenguins",
            ...
            "tableone", "tidymodels", "tidyverse", "usethis", "vcd", "VGAM", 
            "viridis", "visdat", "xfun")
