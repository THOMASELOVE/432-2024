...
1. Download and install **the latest version of R** (version **4.3.2** "Eye Holes" **or later**) from <https://cran.case.edu/> or, if you prefer, from <https://cloud.r-project.org/>, which automatically chooses a fast, nearby mirror for you.
    - If you have a pre-existing installation of R and/or RStudio, we highly recommend that you re-install both to get current.

2. Download and install **RStudio Desktop** (Open Source Edition - the free version **RStudio 2023.12.0+369** "Ocean Storm" **or later**) by visiting <https://posit.co/download/rstudio-desktop/#download>. This will also load everything you need for Quarto.
...
pkgs <- c(  "afex", "aplpack", "aplore3", "arm", "babynames", "bestglm", 
            "boot", "broom", "car", "caret", "cowplot", "cutpointr", 
            "DataExplorer", "DescTools", "devtools", "distributions3", 
            "Epi", "exact2x2", "ez", "faraway", "fivethirtyeight", 
            "foreign", "gapminder", "gee", "geepack", "GGally", "ggdist",
            "ggforce", "ggrepel", "ggridges", "ggstance", "ggthemes", 
            "glmnet", "glue", "gmodels", "gridExtra", "gt", "gtExtras", 
            "gtsummary", "here", "Hmisc", "HSAUR", "infer", "janitor", 
            "kableExtra", "knitr", "lars", "lattice", "leaps", "lmboot", 
            "lme4", "lmerTest", "lmtest", "lvplot", "magrittr", "markdown", 
            "MASS", "mice", "mitml", "MKinfer", "modelsummary", "moderndive", 
            "mosaic", "multcomp", "naniar", "NHANES", "nhanesA", "nnet",
            "palmerpenguins", "party", "patchwork", "posterdown", "pROC", 
            "PropCIs", "pscl", "psych", "pwr", "qcc", "QuantPsyc", "quantreg",
            "ResourceSelection", "rmarkdown", "rmdformats", "rms", 
            "robustbase", "ROCR", "rpart", "rpart.plot", "rstanarm", "rstatix",
            "sandwich", "simputation", "spelling", "styler", "summarytools", 
            "survival", "survminer", "tableone", "tidymodels", "tidytext",
            "tidyverse", "usethis", "vcd", "VGAM", "viridis", "visdat",
            "xfun")
...
5. There are some additional packages we will load outside of CRAN, using the following approach:
...
Execute those lines of code, as well. If you are asked to respond to questions, follow the recommendations provided in the request.

6. Finally, choose **File** ... **Quit Session** from the top menu.
...
- Once 432 begins, if you're having installation problems or problems getting started in R, please consider visiting TA office hours or perhaps asking a question on Campuswire. We want to hear from you!
